    ...
    <main className={styles.home}>
      ...
      <section className={styles.metrics} aria-label="Supraja Group at a glance">
        ...
        <div className={styles.metric}>
          ...
          <span className={styles.metricLabel}>Families served</span>
        </div>
        <div className={styles.metric}>
          <strong>10+</strong>
          <span className={styles.metricLabel}>Completed developments</span>
        </div>
        <div className={styles.metric}>
          <strong>4</strong>
          <span className={styles.metricLabel}>Core business sectors</span>
        </div>
      </section>

      <section className={styles.intro}>
        <div>
          <p className={styles.sectionLabel}>02 / One vision, multiple ventures</p>
      ...
      <section className={styles.businesses}>
        <div className={styles.businessesHeader}>
          <p className={styles.sectionLabel}>03 / Our businesses</p>
        ...
        {businesses.map((business) => (
          <article className={styles.businessRow} key={business.name}>
            ...
            <div className={styles.businessCopy}>
              ...
              <p>{business.copy}</p>
              <a className={styles.businessLink} href={business.href}>
                Explore business <span aria-hidden="true">↗</span>
              </a>
            </div>
            <div className={styles.businessVisual}>
              <img src={business.image} alt={`${business.company} business`} loading="lazy" />
              <img
      ...
      <section className={styles.leadership}>
        ...
        <div className={styles.leadershipCopy}>
          <p className={styles.sectionLabel}>04 / Leadership</p>
          <blockquote>
          ...
          <Link className={styles.textLink} href="/leadership">
      ...
      <section className={styles.brands}>
        <div className={styles.brandsHead}>
          <p className={styles.sectionLabel}>05 / Brand family</p>
          <div>
            <h2>Trusted identities under one group.</h2>
            <p className={styles.brandLabel}>Distinct businesses. One shared commitment to trust, quality and responsible growth.</p>
          </div>
        </div>
        <div className={styles.brandGrid}>
          {brands.map(([src, alt]) => (
            <div className={styles.brandTile} key={alt}>
      ...
      <section className={styles.purpose}>
        <div>
          <p className={styles.sectionLabel}>06 / Purpose beyond business</p>
          <h2>Progress becomes meaningful when it improves lives.</h2>
        </div>
        <div className={styles.purposePoints}>
          <div className={styles.purposePoint}>
            <strong>People</strong>
            <span>Supporting opportunity</span>
          </div>
          <div className={styles.purposePoint}>
      ...
      <section className={styles.contact}>
        <div>
          <p className={styles.sectionLabel}>07 / Connect with Supraja Group</p>
